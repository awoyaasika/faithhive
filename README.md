#FaithHive OS – A Cloud Based Church  Management System
...
FaithHive helps churches manage their members, visitors, activities,finances and events — all in the cloud.
...
Run the test program (once Node.js is installed):
~ node test.js
